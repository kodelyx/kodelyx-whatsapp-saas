...
import { Search, X, PanelRightClose, PanelRightOpen } from 'lucide-react';
  ...
  return (
    <header className="flex items-center justify-between px-4 py-2 border-b bg-card shrink-0 h-[60px]">
      ...
      <div className="flex items-center gap-1">
        {showSearch ? (
          <div className="flex items-center gap-1">
            <Input value={searchQuery} onChange={e => setSearchQuery(e.target.value)} placeholder="Search messages..." className="h-8 w-48 text-sm" autoFocus />
