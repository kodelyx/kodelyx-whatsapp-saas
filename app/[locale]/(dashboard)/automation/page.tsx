...
import { GitMerge, Trash2, Bot, Smartphone, MessageSquareReply } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-muted p-6">
      <header className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-2">
          <Link href="/automation/auto-reply">
            <Button variant="outline"><MessageSquareReply className="h-4 w-4 mr-2" /> Auto-Reply</Button>
          </Link>
